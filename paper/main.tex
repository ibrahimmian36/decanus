...
of the development --- the soundness layer, both certificate rungs, and
the generated drivers --- replay without error; the two axiom-gate
...
$\{\mathtt{propext}, \mathtt{Classical.choice}, \mathtt{Quot.sound}\}$
\cite{decanus}: no $n$ with $24 < n \le 10^7$, $10^8$, or $10^9$
