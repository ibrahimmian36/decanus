...
Certified, in Lean 4.30.0 / mathlib v4.30.0, with axiom closure
exactly $\{\mathtt{propext},\ \mathtt{Classical.choice},\
\mathtt{Quot.sound}\}$ \cite{decanus}: no $n$ with $24 < n \le 10^7$,
$10^8$, or $10^9$
satisfies the problem's inequality, stated against the pinned
\texttt{formal-conjectures} predicate. The $10^7$ and $10^8$ rungs are
